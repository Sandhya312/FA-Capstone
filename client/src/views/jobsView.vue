  ...
  <div class="job-page">
    <div class="job-details">
      ...
      <div class="job-skills">
        ...
        <div
          class="skill-badge"
          v-for="skill in job.mandatory_skills"
          :key="skill"
        >
          <h4>{{ skill }}</h4>
        </div>
      ...
      <form>
        <!-- Form fields go here -->
        <button class="submit-btn" @click.prevent="applyJob()" type="submit">
          <p>Apply</p>
        </button>
      </form>
    </div>
    ...
    async getJob() {
      try {
        ...
        const response = await axios.get(
          `https://fa-capstone.onrender.com/jobs/${id}`
        );
    ...
    async applyJob() {
      try {
        ...
        const response = await axios.post(
          `https://fa-capstone.onrender.com/jobs/${id}/apply`,
          {
            user_id,
          }
        );
